...
data = open_df("input_u2u_2_actors.csv", SIZES, force_decimals=True)
...
line_plot_err(ax, data, offsets, ".2f", offset_text=False, error_bar_kws={
    "elinewidth": 0.8,
    "capthick": 0.8,
    "ecolor": "gray"
})
...
plt.savefig("out/input_u2u_2_actors_interpol.pdf", bbox_inches="tight", pad_inches=0)