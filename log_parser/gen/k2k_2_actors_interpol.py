...
data = open_df("k2k_2_act.csv", SIZES, force_decimals=True)

plt.figure(figsize=(12, 6.75))
ax = plt.gca()

ax.axis(ymin=13, ymax=19)
...
line_plot_err(ax, data, offsets, ".2f", error_bar_kws={
    "elinewidth": 0.8,
    "capthick": 0.8,
    "ecolor": "gray"
}, offset_text=True, text_offset_mult=4)
...
plt.savefig("out/k2k_2_actor_regress.pdf", bbox_inches="tight", pad_inches=0)